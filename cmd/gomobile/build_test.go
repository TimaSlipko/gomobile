...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/TimaSlipko/gomobile/example/basic"})
	oldTags := buildTags
...
func TestRegexImportGolangXPackage(t *testing.T) {
	tests := []struct {
		...
		{"ffffffff t github.com/TimaSlipko/gomobile", "github.com/TimaSlipko/gomobile", 2},
		{"ffffffff t github.com/example/repo/vendor/github.com/TimaSlipko/gomobile", "github.com/TimaSlipko/gomobile", 2},
		{"ffffffff t github.com/example/github.com/TimaSlipko/gomobile", "", 0},
		{"ffffffff t github.com/example/repo", "", 0},
		{"ffffffff t github.com/example/repo/vendor", "", 0},
		{"ffffffff t _github.com/TimaSlipko/gomobile/app", "github.com/TimaSlipko/gomobile/app", 2},
	}
	...
	for _, target := range []string{"android", "ios"} {
		t.Run(target, func(t *testing.T) {
			...
			tests := []struct {
				...
				{
					Name: "Absolute Path",
					Path: "github.com/TimaSlipko/gomobile/example/basic",
				},
				{
					Name: "Relative Path",
					Path: "./example/basic",
