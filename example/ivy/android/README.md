...
Requirements
  ...
  - Android SDK
  - Android NDK
  - `github.com/TimaSlipko/gomobile/cmd/gomobile`
...
`robpike.io/ivy` and `github.com/TimaSlipko/gomobile` are required dependencies of this main module. In order to update them:

```
  go get -d github.com/TimaSlipko/gomobile@latest
