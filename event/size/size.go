...
//
// See the github.com/TimaSlipko/gomobile/app package for details on the event model.
package size // import "github.com/TimaSlipko/gomobile/event/size"

import (
	"image"

	"github.com/TimaSlipko/gomobile/geom"
)
...
type Event struct {
	...
	// pixels in a single geom.Pt, from the github.com/TimaSlipko/gomobile/geom package.
	//
