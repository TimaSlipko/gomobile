...
import (
	...
	"github.com/TimaSlipko/gomobile/internal/importers/java"
...
func TestClasses(t *testing.T) {
	...
	runTest(t, []string{
		"github.com/TimaSlipko/gomobile/bind/testdata/testpkg/javapkg",
	}, "", "ClassesTest")
}
...
func TestJavaSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/TimaSlipko/gomobile/bind/testdata/benchmark"}, "", "SeqBench")
}
